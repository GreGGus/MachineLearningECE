...
res_test=[];
	...
	waitbar(l/ 60,h,iteration);


	%% Base log -> Dichotomie

	%%  [TEA, TET, pmc]=apprend_pmc(vall_app,Ya,vall_test,Yt,0.01,{10,10});
	 	[TEA, TET, pmc]=apprend_pmc(vall_app,Ya,vall_test,Yt,0.01,{80,l});
	...
	RES = [RES;[80,l ,ErrorRateApp, ErrorRateTest]];

end


save dataSetTP3TwoLayer.dat RES res_app res_test
